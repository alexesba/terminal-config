...
Optional terminal maps (see `terminal-emulators/*.example`): **Alt+/** runs `help`.
...
Ctrl+S, Ctrl+H, and Ctrl+B are intentionally unbound — flow control, backspace, and tmux prefix respectively.
